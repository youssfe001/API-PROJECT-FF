...
const LikeProfile_request = {
  accountId: { field: 1, type: "uint64" },
};

const LikeProfile_response = {
  result: { field: 1, type: "uint32" },
};
...
module.exports = {
  ...
  "LikeProfile.request":              LikeProfile_request,
  // Responses
  ...
  "LikeProfile.response":            LikeProfile_response,
